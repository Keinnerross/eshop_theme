document.addEventListener('DOMContentLoaded', function () {
    Swal.fire({
        html: `
            <div class="w-full flex gap-8 h-full bg-white rounded-3xl shadow-xl">
            <div class="w-[50%] overflow-hidden rounded-tl-2xl rounded-bl-2xl ">
                ...
                <div class="flex w-[50%] flex-col items-center text-left py-16 pr-8">
                     <div class="w-full flex flex-col gap-6">
                <h2 class="text-4xl text-text font-semibold">Welcome to Our Gift Shop</h2>
...
<p class="text-sm text-text-light pt-4">
                    Whether you're looking for unique items for yourself or a special gift for someone else, our shop offers a variety of handcrafted goods, religious items, and exclusive community products. By shopping with us, you're helping to strengthen our congregation and build a vibrant, welcoming community.</p>
                      ...
                      <span id="confirm-btn" class="cursor-pointer w-[200px] text-center mt-4 px-6 py-2 bg-blue-500 text-white rounded-lg hover:bg-blue-600">
                    Aceptar
                </span>
                </div>
            </div>
        `,
        customClass: {
            popup: 'w-[70vw] min-h-[75vh] rounded-2xl shadow-lg !p-0 z-[9999999999]',
        },
