...
{
?>
    <div id="sidebarShopMobile" class="fixed hidden top-0 left-0 w-screen h-screen z-[999] bg-black bg-opacity-50">
        <div class="w-[70vw] h-screen bg-white border-t-4 border-blue-800">

            <div id="closeBtnSideShop" class="px-4 absolute top-10 right-4 bg-blue-600">
