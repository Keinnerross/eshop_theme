...
<div>
	...
	<form class="woocommerce-EditAccountForm edit-account" action="" method="post" <?php do_action('woocommerce_edit_account_form_tag'); ?>>
		...
		<fieldset class="changePasswordContainer">
			<h4 style="font-weight: bold"><?php esc_html_e('Password change', 'woocommerce'); ?></h4>
		...
		<p>
			...
			<button type="submit"
				class="woocommerce-Button button buttonMyAccountEdit<?php echo esc_attr(wc_wp_theme_get_element_class_name('button') ? ' ' . wc_wp_theme_get_element_class_name('button') : ''); ?>"
